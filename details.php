...
if (!$conn) {
  ...
  ?>
	...
	$insertt= $conn->query("SELECT hno from regular where status='fail' and branch='$token2' GROUP BY hno HAVING count(hno)>=1");
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
	<?php
	$sub=$conn->query("SELECT COUNT(DISTINCT subcode) as sub FROM `regular` where branch='$token2'");
	$subj = $sub -> fetch_assoc();
	$subjects=$subj['sub'];
	
	$insertt= $conn->query("SELECT hno from regular where status='pass' and branch='$token2' GROUP BY hno HAVING count(hno)>='$subjects'");
	while( $row = mysqli_fetch_assoc($insertt) ) {
